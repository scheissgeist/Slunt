...
class CallbackHumorEngine {
  constructor(chatBot) {
    ...
    // Configuration
    this.maxMoments = 100;
    this.callbackChance = 0.30; // 🔥 COMEDY FIX: 2% → 30% (10X increase - actually use callbacks!)
    this.minTimeBetweenCallbacks = 2 * 60 * 1000; // 🔥 COMEDY FIX: 15 min → 2 min (let running gags run!)
    this.lastCallback = 0;
